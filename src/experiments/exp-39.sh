#################################################################################
#
# Experiment 39: Keep POS & last 6 morphemes.
#
	...
	if(i == 2)
		...
		if(i == 3)
			...
			printf "%s_%s_%s", $1, $2, $3 > "pruned.data"
                        ...
                        printf "%s_%s_%s_%s_%s_%s_%s", $1, $2, $3, $4, $5, $6, $7 > "pruned.data"
		else
			printf "%s_%s_%s_%s_%s_%s_%s_%s_%s", $1, $2, $(i-7), $(i-6), $(i-5), $(i-4), $(i-3), $(i-2), $(i-1) > "pruned.data"
